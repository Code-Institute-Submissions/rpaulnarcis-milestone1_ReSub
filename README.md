...
#### Existing Features:
Feature 1:
- The Sign-Up button allows users to register for our service by creating a user name and password.

Feature 2 :
- The Sign-In / Sign-Up button allows users to register for our service by creating a user name and password and also allows existing users to log in.

Feature 3 :
- The navigational Links make it easy to move back and forth from page to page.
...
- Creating a new account is very simple it can be done in two places on the main page by clicking on the sign-up button at the center of the page as well as a sign-ip/log-up button in the navbar. On every other page, it can be done by clicking the sign-in/log-up button in the navbar.

- Logging in to the gym's website can be done by clicking on the sign-in/sign-up button in the navbar on all pages.

- As a user, you do have access to the gyms website and all its features which are easily accessible via the navbar links and information displayed on each page.

- All users will have full access to all gym equipment as stated in our mission statement.

- As we have stated in our mission statement you have the full support of our dedicated instructors and you can contact us anytime via phone, email, or in person.
...
#### Manual testing:
I tested on Opera, microsoft edge and crome(desktop) see user test below.

#### Responsiveness / user testing:
#### Manual testing done:
Testing was done on these web brosers for the website and all pages associated with the site in relation to responsiveness.
- On Opera, Microsoft edge, and Google crome. I tested all pages using the toggle device toolbar for:

#### Mobile:
Testing was done on these mobile devices for the website and all pages associated with the site in relation to responsiveness.
...
- Samsung Galaxy Note
#### Tablet:
Testing was done on these tablet devices for the website and all pages associated with the site in relation to responsiveness.
- ipad 1
- ipad 2
...
#### Laptop / Desktop:
Testing was done on these laptop/desktop devices for the website and all pages associated with the site in relation to responsiveness.
